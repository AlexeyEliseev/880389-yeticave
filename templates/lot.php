...
<div class="page-wrapper">
  ...
  <main>
    ...
    <section class="lot-item container">
      <h2><?=$result[0]['lotname'];?></h2>
      <div class="lot-item__content">
        <div class="lot-item__left">
          <div class="lot-item__image">
            <img src="<?=$result[0]['image'];?>" width="730" height="548" alt="Сноуборд">
          </div>
          <p class="lot-item__category">Категория: <span><?=$result_p[0]['name'];?></span></p>
          <p class="lot-item__description"><?=$result[0]['description'];?></p>
        </div>
          ...
          <div class="lot-item__state">
            ...
            <div class="lot-item__cost-state">
              <div class="lot-item__rate">
                ...
                <span class="lot-item__cost"><?=$result[0]['cost'];?></span>
              </div>
