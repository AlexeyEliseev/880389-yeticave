...
<div class="page-wrapper">
  ...
  <header class="main-header">
    <div class="main-header__container container">
      ...
      <a class="main-header__add-lot button" href="lot.php">Добавить лот</a>
      <nav class="user-menu">
  ...
  <main>
    ...
    <form class="form container" action="registration.php" method="post"> <!-- form--invalid -->
      ...
      <div class="form__item"> <!-- form__item--invalid -->
        ...
        <input id="email" type="text" name="reg[email]" placeholder="Введите e-mail" required>
        <span class="form__error">Введите e-mail</span>
      </div>
      <div class="form__item">
        <label for="password">Пароль*</label>
        <input id="password" type="password" name="reg[password]" placeholder="Введите пароль" required>
        <span class="form__error">Введите пароль</span>
      </div>
      <div class="form__item">
        <label for="name">Имя*</label>
        <input id="name" type="text" name="reg[name]" placeholder="Введите имя" required>
        <span class="form__error">Введите имя</span>
      </div>
      <div class="form__item">
        <label for="message">Контактные данные*</label>
        <textarea id="message" name="reg[message]" placeholder="Напишите как с вами связаться" required></textarea>
      ...
      <div class="form__item form__item--file form__item--last">
        ...
        <div class="form__input-file">
          <input class="visually-hidden" type="file" id="photo2" value="" name="reg[image]">
          <label for="photo2">
            <span>+ Добавить</span>
          </label>
        </div>
